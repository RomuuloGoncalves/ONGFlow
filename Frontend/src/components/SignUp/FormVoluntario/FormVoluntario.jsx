...
function FormVoluntario({ aoAlterar }) {
  ...
  return (
    <div className="container-inputs-voluntario">
      ...
      <div className="grupo-input">
        <IconeEmail className="icone" />
        <input type="email" name="email" placeholder="Endereço de Email" value={dados.email} onChange={manipularMudanca} />
      </div>
      <div className="grupo-input">
        <IconeSenha className="icone" />
        <input type="password" name="senha" placeholder="Senha" value={dados.senha} onChange={manipularMudanca} />
      </div>
      <div className="grupo-input">
        <IconeCpf className="icone" />
