        ...
        <form className={styles.containerFormulario} onSubmit={handleSubmit}>
          <div className={styles.cabecalhoFormulario}>
            <div className={styles.titulo}>
              <Link to="/">
                <button type="button" className={styles.botaoVoltar}>
                  <IconeSetaEsquerda />
                </button>
              </Link>
              <h1>Login</h1>
          ...
          <div className={styles.seletorTipo}>
            <button
              ...
              onClick={() => handleTypeChange("VOLUNTARIO")}
            >
              Voluntário
            </button>
            <button
          ...
          <div className={styles.grupoInput}>
            ...
            />
            {errors.email && (
              <span className={styles.erro}>{errors.email[0]}</span>
            )}
          </div>
          <div className={styles.grupoInput}>
            <input
            ...
            />
            {errors.password && (
              <span className={styles.erro}>{errors.password[0]}</span>
            )}
          </div>

          {errors.general && (
            <p className={styles.erroGeral}>{errors.general}</p>
          )}
